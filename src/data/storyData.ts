...
print(data.dtypes)`,
  ...
  {
    id: 'ml-practitioner',
    title: 'The ML Practitioner\'s Path',
    description: 'Dive deeper into machine learning algorithms and real-world applications.',
    story: 'You\'ve mastered the basics. Now it\'s time to become a true practitioner of the art.',
    difficulty: 'intermediate',
    estimatedTime: '12-16 weeks',
    skills: ['Advanced Algorithms', 'Model Evaluation', 'Feature Engineering', 'Hyperparameter Tuning'],
    prerequisites: ['Data Explorer Track'],
    rewards: {
      xp: 2000,

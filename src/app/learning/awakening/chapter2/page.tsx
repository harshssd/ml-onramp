...
import { ArrowLeft, Play, Clock, Star, CheckCircle, BookOpen, Sparkles, Brain } from 'lucide-react';
...
const lessons = [
  {
    ...
    duration: 20,
    description: 'Understand the difference between traditional programming and machine learning',
    icon: '⚖️'
  },
  {
    ...
    duration: 20,
    description: 'Explore how data quality affects machine learning models',
    icon: '📊'
  },
  {
    ...
    duration: 25,
    description: 'Learn why we split data and how it affects model performance',
    icon: '✂️'
  },
  {
    ...
    duration: 20,
    description: 'Understand how models learn by reducing error through feedback',
    icon: '📉'
  },
  {
...
export default function AIAwakeningChapter2Page() {
  ...
  return (
    <div className={`min-h-screen ${themeClasses.background} p-4 sm:p-8`}>
      <Button onClick={() => router.push('/learning/awakening/chapter1')} className="mb-6">
        <ArrowLeft className="h-4 w-4 mr-2" /> Back to Chapter 1
      </Button>
      ...
      <div className="text-center mb-8">
        ...
        <p className={`text-xl ${themeClasses.text}/70 max-w-3xl mx-auto`}>
          Now that you understand what AI is, let's dive into HOW machines actually learn. 
          Discover the fundamental concepts that make machine learning possible, from data 
          to training to your first model.
        </p>
      </div>
        ...
        <CardContent className="p-6">
          <div className="text-center">
            ...
            <p className={`${themeClasses.text} italic text-lg mb-4`}>
              "You've seen what AI can do, but now it's time to understand HOW it does it. 
              This is where the magic of machine learning begins."
            </p>
            <p className={`${themeClasses.text}/80`}>
              Every machine learning model starts with data and learns through experience. 
              By the end of this chapter, you'll have built your first model and understand 
              the fundamental principles that power all AI systems.
            </p>
          </div>
        </CardContent>
      </Card>
        ...
        <Card className={`${themeClasses.card} backdrop-blur-sm border ${themeClasses.border} mt-8`}>
          <CardContent className="p-6 text-center">
            ...
            <p className={`${themeClasses.text}/80 mb-6`}>
              Congratulations! You've mastered the fundamentals of machine learning. 
              You now understand how machines learn from data and have built your first model.
            </p>
